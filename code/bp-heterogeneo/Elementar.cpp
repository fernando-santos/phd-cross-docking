...
int Elementar::calculaCaminhoElementar(Grafo* g, bool fullTime, int classe){
...
Rota** Elementar::getRotaCustoMinimo(Grafo* g, int classe, float percentual){
	float limiteAceitacao, custoR;
	int depositoArtif = g->getNumVertices()-1;
	int numCommoditiesGrafoOriginal = g->getNumCmdt();
