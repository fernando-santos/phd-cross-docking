...
int StateSpaceRelax::calculaCaminhoElementarSSR(Grafo* g){
	int violado;
...
int StateSpaceRelax::calculaCaminhos(Grafo* g){
...
Rota** StateSpaceRelax::getRotaCustoMinimo(Grafo* g, float percentual){
